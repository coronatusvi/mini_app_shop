...
export const listNameProducts = [
  "Dịch vụ kiểm tra và bảo trì màn hình máy tính Dell",
  "Sửa chữa túi Coach Tabby 26",
  "Dịch vụ làm sạch ghế gaming (chỉ nhận tại chỗ)",
  "Bảo trì và sửa chữa Playstation 4 Phiên bản Blue Exclusive (cùng với trò chơi)",
  "Dịch vụ làm mới ghế sofa Heimer Miller (Tình trạng tuyệt vời)",
  "Dịch vụ kiểm tra Gopro hero 7 (kèm hóa đơn)",
  "Dịch vụ bảo trì Lego StarWar edition",
  "Sửa chữa Macbook Pro 16 inch (2020) và Dịch vụ Bán hàng",
  "Dịch vụ bảo trì DJI Mavic Pro 2",
  "Dịch vụ bảo trì xe đạp mới, chỉ nhận khách hàng địa phương",
];
